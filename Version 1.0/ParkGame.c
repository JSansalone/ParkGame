...
int check_colision()
{
    ...
    */
    ...
    //printf("\nfrente do carro: (%.2f,%.2f) (%.2f,%.2f)",extremes[0][0]/W_W,extremes[0][1]/W_W,extremes[1][0]/W_W,extremes[1][1]/W_W);
}
...
void translateCar()
{
    ...
    for(i=0; i<86; i=i+1)
    {
        for(j=0; j<4; j=j+2)
        {
            translate(i, car[i][j], car[i][j+1], j, j+1, direction[1], direction[0]);
        }
    }
}
